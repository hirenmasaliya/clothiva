          ...
          <div className="lg:col-span-5 flex flex-col pt-4">
            ...
            <div className="space-y-8 pt-4">
              <button
                ...
                className="w-full bg-stone-900 text-white py-8 rounded-4xl text-[11px] font-bold uppercase tracking-[0.4em] hover:bg-red-900 transition-all shadow-2xl shadow-stone-900/10 active:scale-95 flex items-center justify-center gap-4 group"
              >
                <ShoppingBag size={16} />
